...
import com.example.gtg.cineaplication.widgets.VerticalSpaceItemDecoration;
...
//		DividerItemDecoration divider = new DividerItemDecoration(rclListar.getContext(),
//			lmn.getOrientation());
		rclListar.addItemDecoration(new VerticalSpaceItemDecoration(50));

		//public void salvarFilme(View view){
		//    if(validarCampos()) {
	     /*
            filme.setCartaz(uriImagemSelecionada != null ? uriImagemSelecionada.toString() : uriImagemPadrao
            .toString());
